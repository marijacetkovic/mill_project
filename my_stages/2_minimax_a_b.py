...
def minimax(model, player, maximizing, depth, alpha=-math.inf, beta=math.inf):
    ...
    if maximizing:
        ...
        for move in legal_moves:
            ...
            value = minimax(next_model, opponent, False, depth + 1, alpha, beta)
        ...
        for move in legal_moves:
            ...
            # Pass alpha and beta down the recursion
            value = minimax(next_model, opponent, True, depth + 1, alpha, beta)
...
def ai_move(model, player):
    ...
    for move in legal_moves:
        ...
        score = minimax(possible_model, player, False, 1, -math.inf, math.inf)
        if score > best_score:
